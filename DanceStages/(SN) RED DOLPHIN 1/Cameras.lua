...
t.Camera1MessageCommand=function(self)
	ResetCamera()
	--SN 7
	Camera:addz(-30):addy(15):addrotationx(10):smooth(7):addrotationx(-30):addy(10):addrotationy(-25)
end
...
t.Camera4MessageCommand=function(self)
	ResetCamera()
	--SN 2
	Camera:addrotationy(-90):addrotationx(20):addz(-50):linear(2):addz(15)
end
t.Camera5MessageCommand=function(self)
	ResetCamera()
	--SN 4
	Camera:addrotationy(-60):addrotationx(20):addz(-50):linear(4):addz(10):addrotationy(30):addrotationx(10)
end
...
t.Camera9MessageCommand=function(self)
	ResetCamera()
	--SN 7
	Camera:addz(25):addrotationy(180):smooth(6.5):addrotationy(-150)
end
t.Camera10MessageCommand=function(self)
	ResetCamera()
	--SN 5
	Camera:addz(20):addrotationy(-80):smooth(4.5):addrotationx(20):addrotationy(-10):addx(3):addy(2)
end
t.Camera11MessageCommand=function(self)
	ResetCamera()
	--SN 6
	Camera:addz(25):addrotationy(45):smooth(5.5):addrotationy(-40):addrotationx(25):addz(-5)
end
t.Camera12MessageCommand=function(self)
	ResetCamera()
	--SN 7
	Camera:addz(-50):addy(15):addrotationx(10):smooth(6.5):addrotationx(-20):addy(10):addrotationy(-25)
end
t.Camera13MessageCommand=function(self)
	ResetCamera()
	--SN 6
	Camera:addy(45):addrotationx(-47):smooth(5.5):addrotationx(47):addz(-5):addy(-45)
end

	------- WAIT TIMES  -------8
	NumCameras=tonumber(13)
	WaitTime = {7,10,4,2,4,3,5,7,7,5,6,7,6}
