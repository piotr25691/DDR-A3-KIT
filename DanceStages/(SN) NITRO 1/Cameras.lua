...
t.Camera1MessageCommand=function(self)
	ResetCamera()
	--SN 10
	Camera:addz(-400):addy(-30):addrotationx(20):smooth(10):addz(410):addrotationx(-10):addy(30)
end
...
t.Camera5MessageCommand=function(self)
	ResetCamera()
	--SN 2
	Camera:addrotationy(-90):addrotationx(20):addz(-290):linear(2):addz(40)
end
