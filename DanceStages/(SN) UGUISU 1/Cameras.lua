...
t.Camera1MessageCommand=function(self)
	ResetCamera()
	--SN 7
	Camera:addz(-50):addy(15):addrotationx(10):smooth(7):addrotationx(-10):addy(10):addrotationy(-25)
end
t.Camera2MessageCommand=function(self)
	ResetCamera()
	--SN 7
	Camera:addrotationx(90):addz(-60):addx(-20):addy(20):linear(7):addx(25):addy(-25)
end
t.Camera3MessageCommand=function(self)
	ResetCamera()
	--sn 10
	Camera:addz(-50):addy(10):addrotationy(60):linear(10):addy(20):addrotationy(-55):addrotationx(10):addz(10)
end
...
t.Camera7MessageCommand=function(self)
	ResetCamera()
	--sn 5
	Camera:addrotationx(90):addz(-20):linear(5):addrotationy(50):addz(-40)
end
t.Camera8MessageCommand=function(self)
	ResetCamera()
	--SN 3
	Camera:addz(10):addrotationy(-10):linear(3):addrotationy(-20):addrotationx(10)
end
t.Camera9MessageCommand=function(self)
	ResetCamera()
	--sn 5
	Camera:addrotationx(30):addrotationy(40):addz(-60):linear(5):addrotationy(-40):addz(60):addrotationx(-10)
end
...
t.Camera13MessageCommand=function(self)
	ResetCamera()
	--SN 6
	Camera:addz(25):addrotationy(45):smooth(6):addrotationy(-40):addrotationx(10):addz(-5)
end
