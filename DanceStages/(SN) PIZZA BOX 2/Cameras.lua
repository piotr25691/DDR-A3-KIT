...
t.Camera1MessageCommand=function(self)
	...
	--SN 8
	Camera
	:addz(-150):addrotationx(10):addrotationy(10):addx(0):addy(20):smooth(7):addx(-40):addy(-35)
end
...
t.Camera3MessageCommand=function(self)
	ResetCamera()
	--sn 10
	Camera:addz(-70):addy(-10):addrotationy(60):linear(10):addy(20):addrotationy(-55):addrotationx(20):addz(10)
end
...
t.Camera5MessageCommand=function(self)
	ResetCamera()
	--SN 2
	Camera:addrotationy(-90):addrotationx(20):addz(-120):linear(2):addz(40)
end
...
t.Camera16MessageCommand=function(self)
	ResetCamera()
	--SN 10
	Camera:addz(-120):addy(-30):addrotationx(20):smooth(10):addz(120):addrotationx(-10):addy(30)
end
t.Camera17MessageCommand=function(self)
	ResetCamera()
	--SN 10
	Camera
	:addz(-120):addrotationx(20):addrotationy(40):smooth(5):addz(130):addrotationx(-20):addrotationy(-40)
	:smooth(5):addz(-120):addrotationx(20):addrotationy(-40)
end

	------- WAIT TIMES  -------8
	NumCameras=tonumber(17)
	WaitTime = {8,7,10,4,2,4,5,3,5,7,7,5,6,7,6,10,10}
