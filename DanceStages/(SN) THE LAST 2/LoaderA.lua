...
function DSMap(MapCode, _CM, X, Y, Z)
    t[#t + 1] = Def.ActorFrame {
        ...
        Def.Model {
            ...
            OnCommand = function(self)
                if MapCode == "Map_B1" or MapCode == "Map_B2" or MapCode == "Map_B3" or MapCode == "Map_D" or MapCode == "Map_D1" then
                ...
                if MapCode == "Map_A" or MapCode == "Map_B1" or MapCode == "Map_B2" or MapCode == "Map_B3" or MapCode == "Map_C" then
                    self:zoomx(3*1.6)
                end
            end,
        }
