...
t.Camera1MessageCommand=function(self)
	ResetCamera()
	--SN 10
	Camera:addz(-400):addy(-50):addrotationx(20):smooth(10):addz(410):addrotationx(-10):addy(55)
end
t.Camera2MessageCommand=function(self)
	ResetCamera()
	--SN 7
	Camera:addrotationx(90):addz(-86):addx(-20):addy(20):linear(7):addx(25):addy(-25)
end
...
t.Camera5MessageCommand=function(self)
	ResetCamera()
	--SN 2
	Camera:addrotationy(-90):addrotationx(20):addz(-150):linear(2):addz(40)
end
...
t.Camera7MessageCommand=function(self)
	ResetCamera()
	--sn 5
	Camera:addrotationx(90):addz(-30):linear(5):addrotationy(50):addz(-55)
end
